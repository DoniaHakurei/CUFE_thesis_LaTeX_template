...
\titlespacing{\chapter}{0pt}{10pt}{*3}
...
关于这两个变量，原文的描述是：
\begin{quotation}
  \zihao{5}参照前人的方法，以城镇家庭的\textbf{人均实际收入}作为因变量，选择家庭成员的平均年龄、平均受教育程度、户主的性别和政治面貌、家庭中的就业人口比例以及所在省份等作为自变量进行OLS回归，并使用该方程\textbf{预测值}和\textbf{残差}作为家庭的持久收入和不确定收入.
\end{quotation}
